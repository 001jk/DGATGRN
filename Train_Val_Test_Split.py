...
if __name__ == '__main__':
    ...
    TF2file = './Benchmark Dataset/' + net_type + ' Dataset/' + data_type + '/TFs+' + str(num) + '/TF.csv'
    Gene2file = './Benchmark Dataset/' + net_type + ' Dataset/' + data_type + '/TFs+' + str(num) + '/Target.csv'
    label_file = './Benchmark Dataset/' + net_type + ' Dataset/' + data_type + '/TFs+' + str(num) + '/Label.csv'

    train_set_file = './Benchmark Dataset/' + net_type + ' Dataset/' + data_type + '/TFs+' + str(num) + '/Train_set.csv'
    test_set_file = './Benchmark Dataset/' + net_type + ' Dataset/' + data_type + '/TFs+' + str(num) + '/Test_set.csv'
    val_set_file = './Benchmark Dataset/' + net_type + ' Dataset/' + data_type + '/TFs+' + str(num) + '/Validation_set.csv'

    path = './Benchmark Dataset/' + net_type + ' Dataset/' + data_type + '/TFs+' + str(num)
